...
namespace DemoHVI
{
    public partial class Form1 : Form
    {
        ...
        {
            this.module = this.HVI.getModuleIDwithUserName(this.moduleName.Text);
            if (this.module != null)
            {
        ...
        private void writeButton_Click(object sender, EventArgs e)
        {
            ...
            {
                if ((error = this.module.writeVariable((int)(this.registerNumber.Value), (int)(this.value2write.Value))) < 0)
                    MessageBox.Show("Error", SD_Error.getErrorMessage(error), MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
