function AWGtest
    ...
    NET.addAssembly('C:/Program Files (x86)/Signadyne/Libraries/VisualStudio/Reference Assemblies/VS2008/Signadyne.dll');
    ...
    aou.channelWaveShape(0, Signadyne.SD_Waveshapes.AOU_AWG);

    disp('Press any key to run AWG channel 0 with an infinite Gaussian waveform loaded from file...');
    pause;

    % Load waveform file
    wave = Signadyne.SD_Wave('C:/Users/Public/Documents/Signadyne/Examples/Waveforms/Gaussian.csv');
    ...
    if aou.AWG(0, 0, 0, 0, 0, Signadyne.SD_WaveformTypes.WAVE_ANALOG, triangularData) < 0
    ...
    % Load waveform file
    wave = Signadyne.SD_Wave('C:/Users/Public/Documents/Signadyne/Examples/Waveforms/Exponential.csv');
    ...
    % Load waveform to module
    if aou.waveformLoad(Signadyne.SD_WaveformTypes.WAVE_ANALOG, triangularShort, 1) < 0
        disp('Error loading waveform, make sure wave object and its number are correct.');
        aou.close();
        disp('Aborting demo...');
        return;
