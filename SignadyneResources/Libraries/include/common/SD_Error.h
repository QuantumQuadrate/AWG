...
#define SD_ERROR_FW_VERIFICATION_STRING                 "Signadyne Error: Firmware verification failed"

#define SD_ERROR_COMPATIBILITY                          -8036
#define SD_ERROR_COMPATIBILITY_MODULE_STRING            "Signadyne Error: Compatibility error"

#define SD_ERROR_INVALID_TYPE                           -8037
#define SD_ERROR_INVALID_TYPE_STRING                    "Signadyne Error: Invalid type"
